(function (factory) {
  ...
  */
  ...
  function createCtaButton() {
    ...
    jquery('.community-cta-wrapper .cta-button').on('click', function (e) {
      e.stopPropagation();
      e.preventDefault();
      jquery(this).closest('.community-cta-wrapper').toggleClass('open');
    });
    jquery('.community-cta-wrapper .community-link').on('click', function (e) {
      jquery(this).closest('.community-cta-wrapper').toggleClass('open');
    });
    jquery('.community-cta-wrapper .community-link.mailchimp').on('click', function (e) {
      openMailchimpPopup();
    });
    jquery(document).click(function () {
      jquery('.community-cta-wrapper').removeClass('open');
    });
  }
